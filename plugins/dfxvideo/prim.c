...
__inline static unsigned short BGR24to16 (uint32_t BGR);
...
__inline static void UpdateGlobalTP(unsigned short gdata)
{
...
__inline static void SetRenderMode(uint32_t DrawAttributes)
{
...
__inline static BOOL CheckCoord4()
{
 if(lx0<0)
  {
   if(((lx1-lx0)>CHKMAX_X) ||
...
__inline static BOOL CheckCoord3()
{
 if(lx0<0)
  {
   if((lx1-lx0)>CHKMAX_X) return TRUE;
...
__inline static BOOL CheckCoord2()
{
 if(lx0<0)
  {
   if((lx1-lx0)>CHKMAX_X) return TRUE;
...
__inline static BOOL CheckCoordL(short slx0,short sly0,short slx1,short sly1)
{
 if(slx0<0)
  {
